									...
									<div class="login-header">
										...
										<form id="personal_details" enctype="multipart/form-data">  
							                    	...
							                    	<div class="row justify-content-center">
							                    		<div class="col-12 col-md-6 d-flex">
											                 <div class="profile-pic-upload d-flex flex-wrap justify-content-center">
								                        		<div class="cam-col">
								                        			<img src="{{ URL::asset('/assets/img/icons/camera.svg')}}" alt="">
								                        		</div>
					                        ...
					                        <div class="mt-5 text-center">
					                        	<a href="{{url('doctor-register-step3')}}" class="btn btn-primary w-100 btn-lg login-btn step2_submit" id="step2_button" type="submit">continue </a>
					                        </div>
				                        </form>
									</div>
								</div>
