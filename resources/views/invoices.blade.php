											...
											<tbody>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('patient-profile')}}" class="avatar avatar-sm me-2">
																<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/patients/patient.jpg')}}" alt="User Image">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('patient-profile')}}" class="avatar avatar-sm me-2">
																<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/patients/patient1.jpg')}}" alt="User Image">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('patient-profile')}}" class="avatar avatar-sm me-2">
																<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/patients/patient2.jpg')}}" alt="User Image">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('patient-profile')}}" class="avatar avatar-sm me-2">
																<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/patients/patient3.jpg')}}" alt="User Image">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('patient-profile')}}" class="avatar avatar-sm me-2">
																<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/patients/patient4.jpg')}}" alt="User Image">
															</a>
													...
													<td class="text-end">
														<div class="table-action">
															<a href="{{url('sinvoice-view')}}" class="btn btn-sm bg-info-light">
																<i class="far fa-eye"></i> View
															</a>
															<a href="javascript:void(0);" class="btn btn-sm bg-primary-light">
																<i class="fas fa-print"></i> Print
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															...
															<a href="{{url('patient-profile')}}" class="avatar avatar-sm me-2">
																<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/patients/patient5.jpg')}}" alt="User Image">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('patient-profile')}}" class="avatar avatar-sm me-2">
																<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/patients/patient6.jpg')}}" alt="User Image">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('patient-profile')}}" class="avatar avatar-sm me-2">
																<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/patients/patient7.jpg')}}" alt="User Image">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('patient-profile')}}" class="avatar avatar-sm me-2">
																<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/patients/patient8.jpg')}}" alt="User Image">
															</a>
												...
												<tr>
													...
													<td>
														<h2 class="table-avatar">
															<a href="{{url('patient-profile')}}" class="avatar avatar-sm me-2">
																<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/patients/patient9.jpg')}}" alt="User Image">
															</a>
