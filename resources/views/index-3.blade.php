...
<!-- Home Banner -->
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 aos" data-aos="fade-up">
						<img src="{{ URL::asset('/assets/img/banner-1.png')}}" class="img-fluid search-img" alt="" >
					</div>
		...
		<section class="section section-blogs">
			<div class="container-fluid">
				...
				<div class="view-all text-center aos" data-aos="fade-up">	<a href="{{url('blog-list')}}" class="btn btn-primary">View All</a>
				</div>
			</div>
		</section>
		<!-- /Blog Section -->	
