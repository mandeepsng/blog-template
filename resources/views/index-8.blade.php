				...
				<div class="container">
					<div class="banner-info">
						<div class="row align-items-center">
							<div class="col-lg-4">
								<div class="header-banner aos" data-aos="fade-up">
									<h2>Search Doctor, <br> <span class="header-highlight">Make an Appointment</span></h2>
									<p>Discover the best doctors, clinic & hospital the city nearest to you.</p>
								</div>
							</div>
							<div class="col-lg-8">
								<div class="doctor-search aos" data-aos="fade-up">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-3 col-md-4 aos" data-aos="fade-up">
							<div class="special-box text-center">
								<div class="special-body">
									<img src="{{ URL::asset('/assets/img/shapes/spec.png')}}" alt=""/>
									<h4>Orthopedic</h4>
						...
						<div class="col-lg-3 col-md-4 aos" data-aos="fade-up">
							<div class="special-box text-center">
								<div class="special-body">
									<img src="{{ URL::asset('/assets/img/shapes/spec-01.png')}}" alt=""/>
									<h4>Laboratry</h4>
									<a href="{{url('booking')}}" class="spc-book">Book now <i class="fas fa-caret-right"></i> </a>
								</div>
								<div class="row row-sm special-footer">
						...
						<div class="col-lg-3 col-md-4 aos" data-aos="fade-up">
							<div class="special-box text-center">
								<div class="special-body">
									<img src="{{ URL::asset('/assets/img/shapes/spec-02.png')}}" alt=""/>
									<h4>Neurology</h4>
									<a href="{{url('booking')}}" class="spc-book">Book now <i class="fas fa-caret-right"></i> </a>
								</div>
								<div class="row row-sm special-footer">
						...
						<div class="col-lg-3 col-md-4 aos" data-aos="fade-up">
							<div class="special-box text-center">
								<div class="special-body">
									<img src="{{ URL::asset('/assets/img/shapes/spec-03.png')}}" alt=""/>
									<h4>Cardiology</h4>
									<a href="{{url('booking')}}" class="spc-book">Book now <i class="fas fa-caret-right"></i> </a>
								</div>
								<div class="row row-sm special-footer">
						...
						<div class="col-lg-3 col-md-4 aos" data-aos="fade-up">
							<div class="special-box text-center">
								<div class="special-body">
									<img src="{{ URL::asset('/assets/img/shapes/spec-04.png')}}" alt=""/>
									<h4>MRI Scans</h4>
									<a href="{{url('booking')}}" class="spc-book">Book now <i class="fas fa-caret-right"></i> </a>
								</div>
								<div class="row row-sm special-footer">
						...
						<div class="col-lg-3 col-md-4 aos" data-aos="fade-up">
							<div class="special-box text-center">
								<div class="special-body">
									<img src="{{ URL::asset('/assets/img/shapes/spec-05.png')}}" alt=""/>
						...
						<div class="col-lg-3 col-md-4 aos" data-aos="fade-up">
							<div class="special-box text-center">
								<div class="special-body">
									<img src="{{ URL::asset('/assets/img/shapes/spec-06.png')}}" alt=""/>
									<h4>Testing</h4>
									<a href="{{url('booking')}}" class="spc-book">Book now <i class="fas fa-caret-right"></i> </a>
								</div>
								<div class="row row-sm special-footer">
						...
						<div class="col-lg-3 col-md-4 aos" data-aos="fade-up">
							<div class="special-box text-center">
								<div class="special-body">
									<img src="{{ URL::asset('/assets/img/shapes/spec-07.png')}}" alt=""/>
									<h4>Dentist</h4>
									<a href="{{url('booking')}}" class="spc-book">Book now <i class="fas fa-caret-right"></i> </a>
								</div>
								<div class="row row-sm special-footer">
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 aos" data-aos="fade-up">
							<div class="book-best-doctors">
								<div class="book-header">
									<a href="{{url('doctor-profile')}}"><img src="{{ URL::asset('/assets/img/doctors/doctor-01.jpg')}}" alt="" class="img-fluid"></a>
								...
								<div class="doctors-body">
									...
									<div class="row row-sm loc-details">
										<div class="col-6">
											<div class="d-flex align-items-center">
												<a href="javascript:void(0);">
													<img src="{{ URL::asset('/assets/img/shapes/map-plus.png')}}" alt="" />
												</a> 
												<a href="javascript:void(0);">
										...
										<div class="col-6">
											<div class="d-flex align-items-center">
												<a href="javascript:void(0);">
													<img src="{{ URL::asset('/assets/img/shapes/alarm.png')}}" alt="" />
												</a> 
												<a href="javascript:void(0);">
										...
										<div class="col-6">
											<div class="d-flex align-items-center">
												<a href="javascript:void(0);">
													<img src="{{ URL::asset('/assets/img/shapes/consult.png')}}" alt="" />
												</a> 
												<a href="javascript:void(0);">
										...
										<div class="col-6">
											<div class="d-flex align-items-center">
												<a href="javascript:void(0);">
													<img src="{{ URL::asset('/assets/img/shapes/exper.png')}}" alt="" />
												</a> 
												<a href="javascript:void(0);">
						...
						<div class="col-lg-3 col-md-6 aos" data-aos="fade-up">
							<div class="book-best-doctors">
								<div class="book-header">
									<a href="{{url('doctor-profile')}}"><img src="{{ URL::asset('/assets/img/doctors/doctor-02.jpg')}}" alt="" class="img-fluid"></a>
									<div class="img-overlay">
										<i class="fas fa-star"></i>
									</div>
								</div>
						...
						<div class="col-lg-3 col-md-6 aos" data-aos="fade-up">
							<div class="book-best-doctors">
								<div class="book-header">
									<a href="{{url('doctor-profile')}}"><img src="{{ URL::asset('/assets/img/doctors/doctor-03.jpg')}}" alt="" class="img-fluid"></a>
									<div class="img-overlay">
										<i class="fas fa-star"></i>
									</div>
								</div>
						...
						<div class="col-lg-3 col-md-6 aos" data-aos="fade-up">
							<div class="book-best-doctors">
								<div class="book-header">
									<a href="{{url('doctor-profile')}}"><img src="{{ URL::asset('/assets/img/doctors/doctor-04.jpg')}}" alt="" class="img-fluid"></a>
									<div class="img-overlay">
										<i class="fas fa-star"></i>
									</div>
								</div>
					...
					<div class="row">
							...
							<div class="blog-wrap">
								<div class="image-holder">
									<a href="{{url('blog-details')}}">
										<img class="img-fluid" src="{{ URL::asset('/assets/img/shapes/blog-img01.jpg')}}" alt="Post Image">
									</a>
								</div>
								<div class="blog-wrap-body">
									...
									<div class="blog-footer">
										<div class="row row-sm align-items-center">
											<div class="col-6 text-start">
												<a href="{{url('blog-details')}}" class="read-txt" tabindex="0">Read More <i class="fas fa-long-arrow-alt-right"></i></a>
											</div>
											<div class="col-6 text-end">
						...
						<div class="col-md-6 col-lg-4 aos" data-aos="fade-up">
							<div class="blog-wrap">
								<div class="image-holder">
									<a href="{{url('blog-details')}}">
										<img class="img-fluid" src="{{ URL::asset('/assets/img/shapes/blog-img02.jpg')}}" alt="Post Image">
									</a>
								</div>
								<div class="blog-wrap-body">
						...
						<div class="col-md-6 col-lg-4 aos" data-aos="fade-up">
							<div class="blog-wrap">
								<div class="image-holder">
									<a href="{{url('blog-details')}}">
										<img class="img-fluid" src="{{ URL::asset('/assets/img/shapes/blog-img03.jpg')}}" alt="Post Image">
									</a>
								</div>
								<div class="blog-wrap-body">
									<h3><a href="{{url('blog-details')}}">More then 80 clinical trials launch to test coronavirus</a></h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt 
									ut labore et..</p>
									<div class="blog-footer">
										<div class="row row-sm align-items-center">
