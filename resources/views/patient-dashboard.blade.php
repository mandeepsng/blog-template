							...
							<div class="row">
								<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-dashboard-top">
									<div class="card">
										<div class="card-body text-center">
											<div class="mb-3">
												<img src="{{ URL::asset('/assets/img/specialities/pt-dashboard-01.png')}}" alt="" width="55">
											</div>
											<h5>Heart Rate</h5>
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-dashboard-top">
									<div class="card">
										<div class="card-body text-center">
											<div class="mb-3">
												<img src="{{ URL::asset('/assets/img/specialities/pt-dashboard-02.png')}}" alt="" width="55">
											</div>
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-dashboard-top">
									<div class="card">
										<div class="card-body text-center">
											<div class="mb-3">
												<img src="{{ URL::asset('/assets/img/specialities/pt-dashboard-03.png')}}" alt="" width="55">
											</div>
											<h5>Glucose Level</h5>
											<h6>70 - 90</h6>
										</div>
								...
								<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-dashboard-top">
									<div class="card">
										<div class="card-body text-center">
											<div class="mb-3">
												<img src="{{ URL::asset('/assets/img/specialities/pt-dashboard-04.png')}}" alt="" width="55">
											</div>
											...
											<div class="row">
												<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
													<a href="#" class="graph-box">
														...
														<div class="graph-img">
															<img src="{{ URL::asset('/assets/img/shapes/graph-01.png')}}" alt="">
														</div>
												...
												<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
														<a href="#" class="graph-box pink-graph">
															...
															<div class="graph-img">
																<img src="{{ URL::asset('/assets/img/shapes/graph-02.png')}}" alt="">
															</div>
															<div class="graph-status-result mt-3">
																<h3 class="bmi_data_last"></h3>
												...
												<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
													<a href="#" class="graph-box sky-blue-graph">
														...
														<div class="graph-img">
															<img src="{{ URL::asset('/assets/img/shapes/graph-03.png')}}" alt="">
														</div>
														<div class="graph-status-result mt-3">
															<h3 class="bmi_data_last"></h3>
												...
												<div class="col-12 col-md-6 col-lg-4 col-xl-3 patient-graph-box">
													<a href="#" class="graph-box orange-graph">
														...
														<div class="graph-img">
															<img src="{{ URL::asset('/assets/img/shapes/graph-04.png')}}" alt="">
														</div>
														<div class="graph-status-result mt-3">
															<h3 class="bmi_data_last"></h3>
								...
								<div class="card-body pt-0">
									...
									<nav class="user-tabs mb-4">
										<ul class="nav nav-tabs nav-tabs-bottom nav-justified">
											<li class="nav-item">
												<a class="nav-link active" href="{{url('#pat_appointments')}}" data-bs-toggle="tab">Appointments</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="{{url('#pat_prescriptions')}}" data-bs-toggle="tab">Prescriptions</a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="{{url('#pat_medical_records')}}" data-bs-toggle="tab"><span class="med-records">Medical Records</span></a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="{{url('#pat_billing')}}" data-bs-toggle="tab">Billing</a>
											</li>
										</ul>
									</nav>
									<!-- /Tab Menu -->
															...
															<tbody>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="{{url('doctor-profile')}}" class="avatar avatar-sm me-2">
																				<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/doctors/doctor-thumb-07.jpg')}}" alt="User Image">
																			</a>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="{{url('doctor-profile')}}" class="avatar avatar-sm me-2">
																				<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/doctors/doctor-thumb-08.jpg')}}" alt="User Image">
																			</a>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="{{url('doctor-profile')}}" class="avatar avatar-sm me-2">
																				<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/doctors/doctor-thumb-09.jpg')}}" alt="User Image">
																			</a>
																...
																<tr>
																	<td>
																		<h2 class="table-avatar">
																			<a href="{{url('doctor-profile')}}" class="avatar avatar-sm me-2">
																				<img class="avatar-img rounded-circle" src="{{ URL::asset('/assets/img/doctors/doctor-thumb-10.jpg')}}" alt="User Image">
																			</a>
