											...
											<div class="navbar">
												<div class="user-details me-auto">
													<div class="float-start user-img">
														<a class="avatar avatar-sm me-2" href="{{url('patient-profile')}}" title="Charlene Reed">
															<img src="{{ URL::asset('/assets/img/patients/patient1.jpg')}}" alt="User Image" class="rounded-circle">
										...
										<div class="call-contents">
											<div class="call-content-wrap">
												<div class="voice-call-avatar">
													<img src="{{ URL::asset('/assets/img/doctors/doctor-thumb-02.jpg')}}" alt="User Image" class="call-avatar">
												...
												<div class="call-users">
													<ul>
														<li>
															<a href="#">
																<img src="{{ URL::asset('/assets/img/patients/patient1.jpg')}}" class="img-fluid" alt="User Image">
