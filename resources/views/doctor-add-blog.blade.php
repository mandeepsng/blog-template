															...
															<ul class="upload-wrap">
																<li>
																	<div class=" upload-images">
																		<img alt="Blog Image" src="{{ URL::asset('/assets/img/img-01.jpg')}}">
																	</div>
																</li>
																<li>
																	<div class=" upload-images">
																		<img alt="Blog Image" src="{{ URL::asset('/assets/img/img-02.jpg')}}">
																	</div>
																</li>
																<li>
																	<div class=" upload-images">
																		<img alt="Blog Image" src="{{ URL::asset('/assets/img/img-03.jpg')}}">
																	</div>
																</li>
															</ul>
														</div>
