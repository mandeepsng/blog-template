								...
								<ul class="list-group list-group-flush">
									<li class="list-group-item">
										<div class="media align-items-center d-flex">
											<div class="me-3">
												<img alt="Image placeholder" src="{{ URL::asset('/assets/img/doctors/doctor-thumb-02.jpg')}}" class="avatar  rounded-circle">
											</div>
								...
								<div class="card-body pt-0">
									<div class="user-tabs">
										<ul class="nav nav-tabs nav-tabs-bottom nav-justified flex-wrap">
											...
											<li class="nav-item">
												<a class="nav-link" href="{{url('#pres')}}" data-bs-toggle="tab"><span>Prescription</span></a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="{{url('#medical')}}" data-bs-toggle="tab"><span class="med-records">Medical Records</span></a>
											</li>
											<li class="nav-item">
												<a class="nav-link" href="{{url('#billing')}}" data-bs-toggle="tab"><span>Billing</span></a>
											</li> 
										</ul>
									</div>
									<div class="tab-content">
														...
														<table class="table table-hover table-center mb-0">
															...
															<tbody>
																...
																<tr>
																	...
																	<td class="text-end">
																		<div class="table-action">
																			<a href="{{url('edit-prescription')}}" class="btn btn-sm bg-success-light">
																				<i class="far fa-edit"></i> Edit
																			</a>
										...
										<div class="tab-pane fade" id="pres">
											<div class="text-end">
												<a href="{{url('add-prescription')}}" class="add-new-btn">Add Prescription</a>
											</div>
											<div class="card card-table mb-0">
												<div class="card-body">
													<div class="table-responsive">
																...
																<tr>
																	...
																	<td class="text-end">
																		<div class="table-action">
																			...
																			<a href="#" class="btn btn-sm bg-success-light" data-bs-toggle="modal" data-bs-target="#add_medical_records">
																				<i class="fas fa-edit"></i> Edit
																			</a>
																			<a href="javascript:void(0);" class="btn btn-sm bg-danger-light">
																				<i class="far fa-trash-alt"></i> Delete
										...
										<div class="tab-pane" id="billing">
											<div class="text-end">
												<a class="add-new-btn" href="{{url('add-billing')}}">Add Billing</a>
											</div>
											<div class="card card-table mb-0">
												<div class="card-body">
													<div class="table-responsive">
																...
																<tr>
																	...
																	<td class="text-end">
																		<div class="table-action">
																			...
																			<a href="{{url('edit-billing')}}" class="btn btn-sm bg-success-light">
																				<i class="fas fa-edit"></i> Edit
																			</a>
																			<a href="javascript:void(0);" class="btn btn-sm bg-danger-light">
																				<i class="far fa-trash-alt"></i> Delete
