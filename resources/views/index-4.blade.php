				...
				<div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel" data-interval="2500"> 
				  <div class="carousel-inner">
					<div class="carousel-item active">
					  <img class="d-block w-100" src="{{ URL::asset('/assets/img/slider/slider-1.jpg')}}" alt="First slide">
					...
					<div class="carousel-item">
					  <img class="d-block w-100" src="{{ URL::asset('/assets/img/slider/slider-2.jpg')}}" alt="Second slide">
					  <div class="carousel-caption d-none d-md-block aos" data-aos="fade-up">
						  <span>We Provide Solution</span>
					...
					<div class="carousel-item">
					  <img class="d-block w-100" src="{{ URL::asset('/assets/img/slider/slider-3.jpg')}}" alt="Third slide">
					  <div class="carousel-caption d-none d-md-block aos" data-aos="fade-up">
