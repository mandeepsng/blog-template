...
@component('components.breadcrumb')                
    @slot('title') Doctor Blog @endslot
    @slot('li_1') Home @endslot
    @slot('li_2') Doctor Blog @endslot
@endcomponent
									...
									<div class="col-md-6 col-xl-4 col-sm-12">
										...
										<div class="blog grid-blog">
											...
											<div class="row pt-3">
												...
												<div class="col text-end"><a href="javascript:void(0);" class="text-danger"><i class="far fa-trash-alt"></i> Inactive</a></div>
											</div>
										</div>
										<!-- /Blog Post -->
